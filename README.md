...
- Авторизация
- Просмотр категорий `( Музыка, Спорт, Кино... )`
- Поиск категории по названию
- Просмотр услуг под выбранную категорию
- Просмотр различных подписок
- Добавление подписки в корзину, а также удаление оттуда
- Оплата корзина с задействованием транзакции
- Просмотр раздела "Корзина"
